...
How to Run Locally: You can run this project on your local machine using Docker (recommended) or Python directly.
...
¡Claro que sí! Tienes toda la razón, es mucho más cómodo para copiar y pegar.

Aquí tienes el código completo del README.md. Solo tienes que copiar este bloque entero y pegarlo en tu archivo en GitHub.

Recuerda reemplazar donde dice [PEGAR TU LINK DE RENDER AQUÍ] con tu URL real.
